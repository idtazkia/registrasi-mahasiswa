...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
                ...
                .antMatchers("/registrasi/mustami")
                .antMatchers("/registrasi/prodi/es")
                .antMatchers("/registrasi/prodi/as")
                .antMatchers("/registrasi/prodi/hes")
                .antMatchers("/registrasi/prodi/mbs")
                .antMatchers("/registrasi/prodi/pes")
                .antMatchers("/selesai")
                ...
                .antMatchers("/brosur/stei")
                .antMatchers("/brosur/d3")
                .antMatchers("/brosur/s2")
                .antMatchers("/buku/ei")
                .antMatchers("/lib/**")
