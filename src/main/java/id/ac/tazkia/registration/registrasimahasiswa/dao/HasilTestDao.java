...
public interface HasilTestDao extends PagingAndSortingRepository<HasilTest, String > {
    ...
    Page<HasilTest> findAllByPendaftarStatusTrueAndPendaftarProgramStudiNotNullAndPendaftarNamaContainingIgnoreCaseOrPendaftarNomorRegistrasiContainingAndPendaftarProgramStudiNotNull(String nomor,String grade,Pageable page);
...
//    Page<HasilTest>  findByJenisTestInOrPendaftarNamaContainingOrPendaftarNamaAsalSekolahContainingIgnoreCaseOrderByPendaftarNomorRegistrasi(List<JenisTest>daftarJenisTest, String nama, String sekolah, Pageable smartPage);
    ...
    Long  countHasilTestByPendaftarProgramStudiNotNullAndPendaftarStatusTrue();
    Long  countHasilTestByPendaftarProgramStudiIsNullAndPendaftarStatusTrue();

    Page<HasilTest> findAllByPendaftarProgramStudiNotNullAndPendaftarStatusTrue(Pageable page);

    Page<HasilTest> findAllByPendaftarProgramStudiNullAndPendaftarNamaContainingIgnoreCaseOrPendaftarNomorRegistrasiContainingAndPendaftarProgramStudiNull(String nomor,String grade,Pageable page);

    Page<HasilTest> findAllByPendaftarProgramStudiNull(Pageable page);
